  ...
  create or replace   view DBT_VOTER_DATA.cleaned.idaho_ncoa_results
  
   as (
    SELECT '2023-10-26 '::date   as INPUT_FILE_DATE,
       'ID'                  AS INPUT_STATE,
       INPUT_RES_COUNTY_DESC AS INPUT_COUNTY,
       ...
       INPUT_RES_ZIP_5       AS INPUT_RESIDENCE_ZIPCODE,
       HOUSEHOLD_POSITION,
       NAME_ID,
       ...
       HOUSEHOLD_ID,
       INDIVIDUAL_ID
FROM RAW.IDAHO_NCOA_RESULTS_2023_10_26
  );
