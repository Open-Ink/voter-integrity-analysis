  ...
  create or replace   view DBT_VOTER_DATA.cleaned.pennsylvania_ncoa_results
  
   as (
    SELECT '2023-11-13'::date   as INPUT_FILE_DATE,
       'PA'                 AS INPUT_STATE,
       ...
       INPUT_ADDRESS_ZIP    AS INPUT_RESIDENCE_ZIPCODE,
       HOUSEHOLD_POSITION,
       NAME_ID,
       ...
       HOUSEHOLD_ID,
       INDIVIDUAL_ID
FROM RAW.PENNSYLVANIA_NCOA_RESULTS_2023_11_13
  );
