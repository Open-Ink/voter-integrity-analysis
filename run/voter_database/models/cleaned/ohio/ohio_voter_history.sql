  ...
  create or replace   view DBT_VOTER_DATA.cleaned.ohio_voter_history
...
FROM (VALUES (1, 'Adams'),
             ...
             (88, 'Wyandot')) AS A (county_id, county_name)
                                   ...
                                   ELECTION_CODE,
                                   VOTE_TYPE_CODE
                            FROM RAW.OHIO_VOTERS_2023_09_25 UNPIVOT (VOTE_TYPE_CODE FOR ELECTION_CODE IN (PRIMARY_2000_03_07,
                                GENERAL_2000_11_07,
                                SPECIAL_2001_05_08,
                                GENERAL_2001_11_06,
                                PRIMARY_2002_05_07,
