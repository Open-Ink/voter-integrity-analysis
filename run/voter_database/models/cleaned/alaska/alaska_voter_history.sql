  ...
  create or replace   view DBT_VOTER_DATA.cleaned.alaska_voter_history
   ...
   as (
    WITH VOTER_HISTORY
         AS (SELECT ASCENSION,
                    ...
                    VH1
             FROM RAW.ALASKA_VOTERS_2023_11_13
...
FROM VOTER_HISTORY VH
         INNER JOIN RAW.ALASKA_NCOA_RESULTS_2023_11_13 ADD_INFO ON VH.ASCENSION = ADD_INFO.INPUT_ASCENSION
WHERE ADD_INFO.RECORD_TYPE IN ('A', 'H')
  );
