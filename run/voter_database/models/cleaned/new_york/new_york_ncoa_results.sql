  ...
  create or replace   view DBT_VOTER_DATA.cleaned.new_york_ncoa_results
...
FROM RAW.NEW_YORK_NCOA_RESULTS_2023_09_20 NCOA
         INNER JOIN DBT_VOTER_DATA.cleaned.new_york_voters V ON NCOA.INPUT_VOTER_ID = V.VOTER_ID
