  ...
  create or replace   view DBT_VOTER_DATA.cleaned.missouri_ncoa_results
  
   as (
    SELECT '2023-10-10'::date                                               as INPUT_FILE_DATE,
       'MO'                                                             AS INPUT_STATE,
       REPLACE(REPLACE(INPUT_COUNTY, 'St.', 'St'), 'De Kalb', 'DeKalb') AS INPUT_COUNTY,
       ...
       HOUSEHOLD_ID,
       INDIVIDUAL_ID
FROM RAW.MISSOURI_NCOA_RESULTS_2023_10_10
  );
