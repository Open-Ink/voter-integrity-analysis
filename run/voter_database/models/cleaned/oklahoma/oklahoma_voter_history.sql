  ...
  create or replace   view DBT_VOTER_DATA.cleaned.oklahoma_voter_history
...
SELECT 'OK'                                        AS STATE_CODE,
       ...
       NULL                                        AS PARTY_VOTED
FROM RAW.OKLAHOMA_VOTER_HISTORY_2023_09_23 VH
         INNER JOIN OK_ELECTIONS ELE ON VH.ELECTION_DATE = ELE.ELECTION_DATE
         INNER JOIN RAW.OKLAHOMA_VOTERS_2023_09_23 V ON VH.VOTER_ID = V.VOTER_ID
  );
