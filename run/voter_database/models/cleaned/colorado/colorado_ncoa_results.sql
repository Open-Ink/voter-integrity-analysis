  ...
  create or replace   view DBT_VOTER_DATA.cleaned.colorado_ncoa_results
  
   as (
    SELECT '2023-11-30'::date         as INPUT_FILE_DATE,
       'CO'                       AS INPUT_STATE,
       INPUT_COUNTY,
       ...
       INPUT_RESIDENTIAL_ZIP_CODE AS INPUT_RESIDENCE_ZIPCODE,
       HOUSEHOLD_POSITION,
       NAME_ID,
       ...
       HOUSEHOLD_ID,
       INDIVIDUAL_ID
FROM RAW.COLORADO_NCOA_RESULTS_2023_11_30
  );
