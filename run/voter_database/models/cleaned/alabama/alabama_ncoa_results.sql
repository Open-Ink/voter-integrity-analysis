  ...
  create or replace   view DBT_VOTER_DATA.cleaned.alabama_ncoa_results
  
   as (
    SELECT '2023-09-01'::date                            as INPUT_FILE_DATE,
       'AL'                                          AS INPUT_STATE,
       REPLACE(INPUT_COUNTY, 'ST_CLAIR', 'St Clair') AS INPUT_COUNTY,
       ...
       HOUSEHOLD_ID,
       INDIVIDUAL_ID
FROM RAW.ALABAMA_NCOA_RESULTS_2024_01_15
  );
