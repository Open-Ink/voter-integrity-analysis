  ...
  create or replace   view DBT_VOTER_DATA.cleaned.nebraska_ncoa_results
  
   as (
    SELECT '2023-11-01'::date  as INPUT_FILE_DATE,
       'NE'                AS INPUT_STATE,
       V.DB_LOGID          AS INPUT_COUNTY,
       INPUT_ID            AS INPUT_VOTER_ID,
       INPUT_LAST_NNAME    AS INPUT_LAST_NAME,
       ...
       HOUSEHOLD_ID,
       INDIVIDUAL_ID
FROM RAW.NEBRASKA_NCOA_RESULTS_2023_11_01 NCOA
         INNER JOIN RAW.NEBRASKA_VOTERS_2023_11_01 V ON V.TEXT_REGISTRANT_ID = NCOA.INPUT_ID
  );
