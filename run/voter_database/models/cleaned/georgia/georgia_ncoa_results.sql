  ...
  create or replace   view DBT_VOTER_DATA.cleaned.georgia_ncoa_results
  
   as (
    SELECT '2023-09-13'::date              as INPUT_FILE_DATE,
       'GA'                            AS INPUT_STATE,
       INPUT_COUNTY,
       INPUT_VOTER_REGISTRATION_NUMBER AS INPUT_VOTER_ID,
       INPUT_LAST_NAME,
       INPUT_FIRST_NAME,
       INPUT_MIDDLE_NAME,
       INPUT_SUFFIX,
       ...
       HOUSEHOLD_ID,
       INDIVIDUAL_ID
FROM RAW.GEORGIA_NCOA_DATA_2023_09_13
  );
