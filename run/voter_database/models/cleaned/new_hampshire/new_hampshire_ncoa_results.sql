  ...
  create or replace   view DBT_VOTER_DATA.cleaned.new_hampshire_ncoa_results
  
   as (
    SELECT '2023-12-04'::date   as INPUT_FILE_DATE,
       'NH'                 AS INPUT_STATE,
       ...
       HOUSEHOLD_ID,
       INDIVIDUAL_ID
FROM RAW.NEW_HAMPSHIRE_NCOA_RESULTS_2023_12_04
WHERE NOT (
    INPUT_ID IN ('189002038',
                 '300189080') AND INPUT_ADDRESS_LINE_1 IS NULL AND INPUT_ADDRESS_LINE_2 IS NULL)
  );
