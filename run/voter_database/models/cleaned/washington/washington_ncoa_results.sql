  ...
  create or replace   view DBT_VOTER_DATA.cleaned.washington_ncoa_results
...
FROM (VALUES ('AD', 'Adams'),
       ...
       HOUSEHOLD_ID,
       INDIVIDUAL_ID
FROM RAW.WASHINGTON_NCOA_RESULTS_2023_09_01 NCOA
         INNER JOIN __dbt__cte__washington_counties C ON NCOA.INPUT_COUNTY_CODE = C.COUNTY_CODE
  );
