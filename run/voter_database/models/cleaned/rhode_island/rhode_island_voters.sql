  ...
  create or replace   view DBT_VOTER_DATA.cleaned.rhode_island_voters
  
   as (
    SELECT '2023-11-16'::date                                                        as FILE_DATE,
       'RI'                                                                      as STATE_CODE,
       ADD_INFO.COUNTY_NAME                                                          as COUNTY_CODE,
...
FROM RAW.RHODE_ISLAND_VOTERS_2023_11_16 VOTERS
         INNER JOIN RAW.RHODE_ISLAND_NCOA_RESULTS_2023_11_16 ADD_INFO
                    ON ADD_INFO.INPUT_VOTER_ID = VOTERS.VOTER_ID AND ADD_INFO.RECORD_TYPE IN ('A', 'H')
WHERE ADD_INFO.COUNTY_NAME IS NOT NULL
