  ...
  create or replace   view DBT_VOTER_DATA.cleaned.rhode_island_ncoa_results
  
   as (
    SELECT '2023-11-16'::date      as INPUT_FILE_DATE,
       'RI'                    AS INPUT_STATE,
       ...
       NCOA.INPUT_ZIP_CODE     AS INPUT_RESIDENCE_ZIPCODE,
       ...
       NCOA.HOUSEHOLD_ID,
       NCOA.INDIVIDUAL_ID
FROM RAW.RHODE_ISLAND_NCOA_RESULTS_2023_11_16 NCOA
         INNER JOIN DBT_VOTER_DATA.cleaned.rhode_island_voters V ON NCOA.INPUT_VOTER_ID = V.VOTER_ID
  );
